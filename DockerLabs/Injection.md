...
![](../images/DockerLabs/Injection3.png)

Usamos *sshpass* para no tener que introducir la contraseña luego.

![](../images/DockerLabs/Injection4.png)

**¡¡Tenemos acceso al sistema!!**

### Tratamiento de la TTY (Opcional)
...
env /bin/bash -p
```
![](../images/DockerLabs/Injection5.png)
